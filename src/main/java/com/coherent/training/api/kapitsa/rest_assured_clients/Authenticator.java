...
public class Authenticator extends RestAssuredClient {
    ...
    private static class SingletonAuthenticator {
        private static final com.coherent.training.api.kapitsa.rest_assured_clients.Authenticator INSTANCE = new com.coherent.training.api.kapitsa.rest_assured_clients.Authenticator();
    }

    public static com.coherent.training.api.kapitsa.rest_assured_clients.Authenticator getInstance() {
        return com.coherent.training.api.kapitsa.rest_assured_clients.Authenticator.SingletonAuthenticator.INSTANCE;
    }
    ...
    private String getBearerTokenForScope(String scope) {
        ...
        Response response = client.post(oauthUrl, setHeadersMap(), getFormMap(scope));

        Token token = client.getResponseBody(response, Token.class);
